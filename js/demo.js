...
$.shareButtons({
  ...
  buttons : {
    ...
    'CONTACT US':   { class: 'glyphicon glyphicon-envelope', target:'#myModal', toggle:'modal', use: true, link: 'contact-us-model.html', title: 'CONTACT US' },
    'PHONE':      { class: 'glyphicon glyphicon-earphone separated',    use: true, link: '+000', title: 'CALL US' },
